...
public class TriggerDynamicsJKD extends JComponent implements Runnable{
private int h; //высота
   ...
   public static void main(String[] args) {
        TriggerDynamicsJKD triggerdynamicsjkd = new  TriggerDynamicsJKD();
        Frame frame = new Frame("Триггер Д");	
        frame.add(triggerdynamicsjkd);
