...
public class LogicalelementorAndNo extends JComponent{
    ...
    public void paint(Graphics g)
 	{
        // Отрисовываем логического элемента
            ...
            g.drawString("Логический элемент И-НЕ", x - 75, y - 10);
    ...
    public static void main(String[] args) {
        LogicalelementorAndNo ili = new LogicalelementorAndNo();
