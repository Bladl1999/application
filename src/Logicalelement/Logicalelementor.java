...
public class Logicalelementor extends JComponent{
    ...
    public void paint(Graphics g)
 	{
        // Отрисовываем логического элемента
            ...
            g.drawString("Логический элемент ИЛИ", x - 60, y - 10);
    ...
    public static void main(String[] args) {
        Logicalelementor ili = new Logicalelementor();
