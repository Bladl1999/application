...
public class TriggerRS_Or_Not extends JComponent implements Runnable{
    ...
    public void paint(Graphics g)
 	{
        ...
        g.setFont(new Font("Dialog",1, height));
 	    ...
 	    //Верхний логический элемент или
        g.drawRect(x, y, w,h * 2);
        g.drawString("1",x + w - width, y + height);
        ...
        //Нижний логичесикий элемент или
        g.drawRect(x , y + h*3, w,h * 2);
        g.drawString("1",x + w - width, y + h*3 +  height);
    ...
    public static void main(String[] args) {
        TriggerRS_Or_Not ili = new  TriggerRS_Or_Not();
